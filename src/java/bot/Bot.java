...
System.out.println( 2.equals(SOCBoard.FACING_E));
				for (int dir = 0; dir < 6; dir++)
				{
					switch (board.getAdjacentNodeToHex(id, dir))
					{
					case dir == SOCBoard.FACING_E :
						System.out.println("Node #" + dir + " =>East");
						break;
					case SOCBoard.FACING_NE:
						System.out.println("Node #" + dir + " =>North East");
						break;
					case SOCBoard.FACING_NW:
						System.out.println("Node #" + dir + " =>North West");
						break;
					case SOCBoard.FACING_SE:
						System.out.println("Node #" + dir + " =>South East");
						break;
					case SOCBoard.FACING_SW:
						System.out.println("Node #" + dir + " =>South West");
						break;
					case SOCBoard.FACING_W:
						System.out.println("Node #" + dir + " =>West");
						break;
					default:
						System.out.println("Node #" + dir + " =>Unknown");
						break;
					}
				}
...
/*
	...
	double calculateTotalScore(int Type, int Number)
	{
		...
		return calculateScoreMaterial(Type, Number) * weightMaterial + calculateScoreSettlements(node) * weightPossibleSettlements ;
	}
